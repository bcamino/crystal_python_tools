...
def plot_spbs(file_name,k_path_s,k_labels,energy_range,slab_bs=None,title=None,newk=12,n_k_points=200,first_band=1,last_band=26,not_scaled=False):
    ...
    for i in np.arange(-0.5,0.6,0.1):
        ...
        runprop(cry_input_name,input_name)
        time.sleep(0.1)
        
        band_file_name = input_name[:-3]+'_dat.BAND'
        print('band_file_name',band_file_name)
